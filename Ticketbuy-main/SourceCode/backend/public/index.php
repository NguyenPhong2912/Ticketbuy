...
$bookingController = new BookingController($bookingRepository, $routeRepository);
...
$adminController = new AdminController($bookingRepository, $routeRepository, $userRepository, $promotionRepository);
...
if ($uri === '/bookings/seats' && $method === 'GET') {
    ...
    $bookedSeats = $bookingRepository->getBookedSeats($routeId, $departureDate);
